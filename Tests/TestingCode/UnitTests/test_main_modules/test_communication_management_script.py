...
class TestCommunicationManagementScript(unittest.TestCase):
    # Test 1: Test that the script can be executed directly
    def test_script_execution(self):
        """Test that the script can be executed directly"""
        # Get the path to the communication_management.py file
        script_path = os.path.join('project_management', 'modules', 'main_modules', 'communication_management.py')
    ...
    def test_script_execution_check_flag(self):
        ...
        try:
            ...
            # Check that the script executed without errors
            self.assertIn("output saved to", result.stdout)
